 ...
 */
final class Version20210121094527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE footwear_product CHANGE section section ENUM(\'male\', \'female\' , \'kids\'), CHANGE durability durability ENUM(\'HIGH\', \'MEDIUM\' , \'LOW\'), CHANGE ease_to_wear ease_to_wear ENUM(\'EASY\', \'MEDIUM\' , \'DIFFICULT\'), CHANGE sole_type sole_type ENUM(\'RUBBER\', \'CAMP\' , \'CORK\'), CHANGE lace_type lace_type ENUM(\'COTTON\', \'NYLON\' , \'ELASTIC\'), CHANGE occasion occasion ENUM(\'PARTY WEAR\', \'CASUAL WEAR\' , \'OFFICE WEAR\'), CHANGE made_in made_in ENUM(\'INDIA\', \'AMERICA\' , \'GEORGIA\'), CHANGE rating rating ENUM(\'3 STAR\', \'4 STAR\' , \'5 STAR\')');
    }
